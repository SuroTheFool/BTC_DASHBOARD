...
class CryptoTicker:
    ...
    def __init__(self, parent, symbol, display_name,image_path):
        ...
        try:
            ...
            self.image_label = tk.Label(self.frame, image=self.tk_image_reference)
...
class SecretTickerApp:
    def __init__(self,root):
        ...
        self.btc_ticker = CryptoTicker(self.ticker_frame, "btcusdt", "BTC/USDT","img/BTC.png")
        
        self.eth_ticker = CryptoTicker(self.ticker_frame, "ethusdt", "ETH/USDT","img/ETH.png")
        
        self.sol_ticker = CryptoTicker(self.ticker_frame, "solusdt", "SOL/USDT","img/SOL.png")
